...
export const Register2 = () => {
  ...
  return (
    <>
      <Link to="/register1" className="link">
        <CreateAccountHeader />
      </Link>
      <form onSubmit={onSubmit} className="register_form" action="">
        ...
        <input
          className="register_inputForm register_inputForm2"
          type="file"
          value={form.name}
          onChange={onChange}
        />
        ...
        <p className="register_text">
          By tapping on “Create an account, you agree to the Apollofy terms of
          use
        </p>

        <h3 className="register_smallTitle">Terms of use</h3>
        <p className="register_text">
          To learn more about how Apollofy collect, uses, shares and protects
          your personal data, Please see the Apollofy Privacy Policy.
        </p>

        <h3 className="register_smallTitle">Privacy Policy</h3>
        <div className="register_toggle-switch-container">
          <span className="register_textCheckbox">
            Please send me news and offers from Apollofy.
          </span>
        ...
        <div className="register_toggle-switch-container">
          <span className="register_textCheckbox">
            Share my registration data with Apollofy´s content providens for
            marketin purposes..
          </span>
          <label className="register_toggle-switch">
            <input
        ...
        <Link to="/" className="link">
          <input
            ...
            className="register_createAccountBtn"
          />
        </Link>
      </form>
    </>
